                                ...
                                <div id={"propiedad-"+obj.nombre}>
                                    ...
                                    <div className="mb-2">
                                        ...
                                        <input className="form-control" type="text" id={"id-"+obj.nombre}
                                               onChange="getPropiedadesObjeto('{{ objeto_.nombre }}')" autoComplete="off"
                                               disabled/>
                                    </div>
                                    {
                                            ...
                                            if(tipo === "TIPO_INT"){
                                                return (
                                                    <div className="mb-2">
                                                        ...
                                                        <input className="form-control" type="number" id={id_input}
                                                               onChange={(e)=>
                                                                   this.props.edit_elemento_attr(this.props.id_seleccionado, name_attr, e.target.value)}
                                                               autoComplete="off"
                                                               value={this.props.mapa.get_attr_value(this.props.id_seleccionado, name_attr)}/>
                                                    </div>
                                                )
                                            }
                                            if(tipo === "TIPO_BOOL"){
